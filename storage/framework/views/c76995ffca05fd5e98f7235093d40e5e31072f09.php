        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('image/feroza.jpg')); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs">Achmad Zein Feroza</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(asset('image/feroza.jpg')); ?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo e(route('dataLahan.index')); ?>">
            <i class="fa fa-files-o"></i>
            <span>Data Tebu</span>
          </a>
        <li>
          <a href="<?php echo e(route('dataPabrik.index')); ?>">
            <i class="fa fa-th"></i> <span>Data Pabrik</span>
          </a>
        </li>
        <li>
          <a href="<?php echo e(route('dataIdentifikasi.index')); ?>">
...
<script src="<?php echo e(asset('bower_components/js/script.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\PPL\resources\views/templates/master-admin.blade.php ENDPATH**/ ?>